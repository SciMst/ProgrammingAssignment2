## Computing the inverse of a matrix is usually  costly. Caching the
## inverse of a matrix may lead to some benefits. 
...
# checks if the inverse has already been computed. If so, it gets the 
#result and skips the computation. If not, it computes the inverse, 
#sets the value in the cache via setinverse function.

# The following function assumes the matrix is invertible
